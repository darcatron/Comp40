/* a2mediate.c
 * Charles Vrettos & Mathurshan Vimalesvaran, 10/3/13
 * Comp 40 HW3 Part C - Provided file
 */
                ...
                (int row, int col, void *elem, void *cl) 
{
  ...
  /* this is the function/closure originally passed */
        ...
        void *cl) 
{
    ...
    Array2_map_row_major(array2, 
           apply_a2methods_using_array2_prototype, &mycl);
}
